...
import 'utils/common/dropdown_with_search_filter.dart';
...
const Map<CscCountry, int> CountriesList = {
...
class NewCSCPicker extends StatefulWidget {
  ...
  const NewCSCPicker({
    ...
    this.countrySearchPlaceholder =
        "${BaseStrings.search} ${BaseStrings.country}",
    this.stateSearchPlaceholder = "${BaseStrings.search} ${BaseStrings.state}",
    this.citySearchPlaceholder = "${BaseStrings.search} ${BaseStrings.city}",
    this.countryDropdownLabel = BaseStrings.country,
    this.stateDropdownLabel = BaseStrings.state,
    this.cityDropdownLabel = BaseStrings.city,
    this.countryFilter,
  });
  ...
  @override
  NewCSCPickerState createState() => NewCSCPickerState();
}

class NewCSCPickerState extends State<NewCSCPicker> {
  ...
  void _setDefaultCountry() {
    if (widget.defaultCountry != null) {
      debugPrint(_country[CountriesList[widget.defaultCountry]!]);
      _onSelectedCountry(_country[CountriesList[widget.defaultCountry]!]!);
    }
  }
  ...
  Future<dynamic> getResponse() async {
    ...
    var res = await rootBundle.loadString(BaseAssets.baseJson);
  ...
  Future<List<String?>> getCountries() async {
    ...
    if (_countryFilter.isNotEmpty) {
      for (var element in _countryFilter) {
        var result = countries[CountriesList[element]!];
